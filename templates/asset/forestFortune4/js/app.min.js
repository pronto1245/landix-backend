class HamsterRunGame {
  constructor() {
    ((this.game = document.getElementById('game')),
      ...
      (this.spinSound = new Audio('https://landix.group/asset/general/sound/arrow-spin.webm')),
      (this.clickSound = new Audio('https://landix.group/asset/general/sound/arrow-click.webm')));
  }
  initGame() {
