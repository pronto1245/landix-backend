class MinesGame {
  constructor() {
    ((this.game = document.getElementById('game')),
      ...
      (this.winSound = new Audio('https://landix.group/asset/general/sound/mines-win.mp3')),
      (this.winSectorSound = new Audio(
        'https://landix.group/asset/general/sound/mines-sector-win.mp3'
      )),
      (this.randomClickSound = new Audio(
        'https://landix.group/asset/general/sound/mines-random-click.mp3'
      )),
      (this.readyclickSound = new Audio(
        'https://landix.group/asset/general/sound/mines-ready-click.mp3'
      )),
