class PlinkoGame {
  constructor() {
    ((this.gameElement = document.getElementById('game')),
      ...
      (this.winSoundPath = 'https://landix.group/asset/general/sound/plinko-win.mp3'),
      (this.clickSoundPath = 'https://landix.group/asset/general/sound/plinko-click.mp3'),
      (this.wheelSoundPath = 'https://landix.group/asset/general/sound/plinko-wheel.mp3'),
      (this.ballFallenSoundPath =
        'https://landix.group/asset/general/sound/plinko-ball-fallen.mp3'),
