  ...
  constructor() {
    ((this.game = document.getElementById('game')),
      ...
      (this.winSound = new Audio(
        'http://localhost:3000/assets/general/sound/playful-casino-slot-machine-jackpot-3-183921.mp3'
      )),
      (this.spinSound = new Audio('http://localhost:3000/assets/general/sound/arrow-spin.webm')),
      (this.clickSound = new Audio('http://localhost:3000/assets/general/sound/arrow-click.webm')));
  }
  initGame() {
