        ...
        a = function (t, n, e) {
          ...
          for (u in (p && (e = n), e))
            ((h = ((f = !v && y && void 0 !== y[u]) ? y : e)[u]),
              (l = g && f ? s(h, r) : m && 'function' == typeof h ? s(Function.call, h) : h),
              y && c(y, u, h, t & a.U),
              b[u] != h && i(b, u, l),
              m && x[u] != h && (x[u] = h));
        };
      ...
      ((l && v) ||
        ...
        'process' == e(8)(h)
          ...
          : d && d.now
            ...
            : p
              ? ((i = (o = new p()).port2), (o.port1.onmessage = b), (r = c(i.postMessage, i, 1)))
        ...
        function (t, n, e, h, l) {
          ...
          if (i(g)) {
            for (v = s(t.length); v > b; b++)
              if ((m = n ? y(c((p = t[b]))[0], p[1]) : y(t[b])) === u || m === f) return m;
          } else
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        e(17)(function () {
          ...
          ? function (t, n) {
              for (var e = s(t), u = arguments.length, f = 1, h = i.f, l = c.f; u > f; )
                for (
                  var v,
                    p = a(arguments[f++]),
    ...
    function (t, n, e) {
      ...
      var r,
        ...
        a =
          ...
          (function () {
            function t(n, e, r) {
              (i()(this, t), (this.ctx = n), (this.mouseX = e), (this.mouseY = r));
            }
            return (
              s()(t, [
                {
                ...
                },
                {
                  ...
                  value: function (t) {
                    (this.ctx.beginPath(),
                      this.ctx.arc(this.mouseX + t, this.mouseY + t, t, 0, 2 * Math.PI, !1),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var n = t,
                      ...
                      r = Math.sqrt(n * n - e * e),
                      o = 2 * Math.random() * r - r;
                    return ((e += n), (o += n), [(e += this.mouseX), (o += this.mouseY)]);
                  }
                },
                {
                  key: 'spray',
                  value: function (t, n, e) {
                    for (var r = 0; r < e; r++) {
                      ...
                      (this.ctx.beginPath(),
                        this.ctx.arc(o[0] + t / 2, o[1] + t / 2, n / 2, 0, 2 * Math.PI, !1),
                        (this.ctx.fillStyle = '#000000'),
                        this.ctx.fill(),
                        this.ctx.closePath());
                    }
      ...
      var h = (function () {
        function t(n, e) {
          ...
          ((this.config = Object.assign(Object.assign({}, s), e)),
            ...
            (this.container = this.isString(n) ? document.querySelector(String(n)) : n),
            (this.position = [0, 0]),
            (this.readyToClear = !1),
            (this.percent = 0),
            (this.callbackDone = !1),
          ...
          s()(t, [
              ...
              value: function () {
                this.zone = (function (t) {
                  for (
                    ...
                    ((n.top += t.offsetTop), (n.left += t.offsetLeft), (t = t.offsetParent));
                  var r = n.left - e.left,
                    o = n.top - e.top;
                  return {
              ...
              value: function () {
                ...
                return new Promise(function (n, e) {
                  u(t.config.imageForwardSrc).then(
                    function (e) {
                      ((t.scratchImage = e),
                        t.ctx.drawImage(t.scratchImage, 0, 0, t.canvas.width, t.canvas.height),
                        t.setBackground(),
                        n());
                    },
                    function (n) {
                      return (
                        e(n),
                        new TypeError(''.concat(t.config.imageForwardSrc, ' is not loaded.'))
                      );
                    }
                  );
                });
              ...
              value: function () {
                ...
                if (0 !== this.config.htmlBackground.length)
                  !(function (t, n) {
                    ...
                    ((r.innerHTML = o.body.innerHTML), n.insertBefore(r, n.firstElementChild));
            ...
            },
            {
              ...
              value: function (t) {
                ...
                switch (t.type) {
                  case 'touchmove':
                    ((n = t.touches[0].clientX - this.config.clearZoneRadius - this.zone.left),
                      (e = t.touches[0].clientY - this.config.clearZoneRadius - this.zone.top));
                    break;
                  case 'mousemove':
                    ((n = t.clientX - this.config.clearZoneRadius - this.zone.left),
                      (e = t.clientY - this.config.clearZoneRadius - this.zone.top));
                }
                return [n, e];
              }
            },
