class MinesGame {
  constructor() {
    ((this.game = document.getElementById('game')),
      ...
      (this.winSound = new Audio('http://localhost:3000/assets/general/sound/mines-win.mp3')),
      (this.winSectorSound = new Audio(
        'http://localhost:3000/assets/general/sound/mines-sector-win.mp3'
      )),
      (this.randomClickSound = new Audio(
        'http://localhost:3000/assets/general/sound/mines-random-click.mp3'
      )),
      (this.readyclickSound = new Audio(
        'http://localhost:3000/assets/general/sound/mines-ready-click.mp3'
      )),
