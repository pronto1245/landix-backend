class MinesGame {
  constructor() {
    ((this.game = document.getElementById('game')),
      ...
      (this.winSound = new Audio('https://api.landix.group/assets/general/sound/mines-win.mp3')),
      (this.winSectorSound = new Audio(
        'https://api.landix.group/assets/general/sound/mines-sector-win.mp3'
      )),
      (this.randomClickSound = new Audio(
        'https://api.landix.group/assets/general/sound/mines-random-click.mp3'
      )),
      (this.readyclickSound = new Audio(
        'https://api.landix.group/assets/general/sound/mines-ready-click.mp3'
      )),
