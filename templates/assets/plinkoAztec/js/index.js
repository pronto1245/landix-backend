class PlinkoGame {
  constructor() {
    ((this.gameElement = document.getElementById('game')),
      ...
      (this.winSoundPath = 'https://api.landix.group/assets/general/sound/plinko-win.mp3'),
      (this.clickSoundPath = 'https://api.landix.group/assets/general/sound/plinko-click.mp3'),
      (this.wheelSoundPath = 'https://api.landix.group/assets/general/sound/plinko-wheel.mp3'),
      (this.ballFallenSoundPath =
        'https://api.landix.group/assets/general/sound/plinko-ball-fallen.mp3'),
